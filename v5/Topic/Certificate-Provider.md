...
## DETAILED DESCRIPTION  
 ...
 NOTE: Beginning in Windows PowerShell 3.0, the Microsoft.PowerShell.Security module that contains the [Certificate Provider](../Topic/Certificate-Provider.md) is not imported automatically into every session. To use the Cert: drive, use the [Import\-Module](assetId:///af616c24-e122-4098-930e-1e3ea2080ade) cmdlet to import the module, or run a command that uses the Cert: drive, such as a "[Set\-Location](assetId:///d7f353cd-ebd7-462a-bd57-1498dc8b88a6) Cert:" command.  
  
 Beginning in [!INCLUDE[wps_2](../Token/wps_2_md.md)] 3.0, the Certificate provider enhances its support for managing Secure Socket Layer \(SSL\) certificates for web hosting by adding support for cmdlets and new dynamic parameters that create and delete certificate stores in the LocalMachine certificate store location, and find, move, and delete certificates.  
  
 New dynamic parameters, DnsName, EKU, SSLServerAuthentication, and ExpiringInDays have been added to the [Get\-ChildItem](assetId:///75cf79bb-4db6-4a67-8c36-3d20754e2190) cmdlet in the Cert: drive. Also, a DeleteKey dynamic parameter has been added to [Remove\-Item](assetId:///0fe3ff11-a1f7-43b9-8c85-f92d52641395) in the Cert: drive. The new dynamic parameters are available in the [!INCLUDE[wps_2](../Token/wps_2_md.md)] 3.0 and newer [!INCLUDE[wps_2](../Token/wps_2_md.md)] releases, and work with IIS 8.0, available on [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and later releases of the Windows Server operating system.  
 ...
 These enhancements are designed to support the WebHosting certificate store created by IIS. This certificate store is optimized to scale for efficient, automated management of the thousands of certificates that are required for dynamic shared hosting. The WebHosting certificate store is available starting in IIS 8.0, available with Web Server \(IIS\) on [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and later releases of the Windows Server operating system.  
 ...
 In Windows PowerShell 3.0, the Certificate provider supports the [Get\-Location](assetId:///b4c8d674-ba23-4bdf-8322-1f08acdc0ca9), [Set\-Location](assetId:///d7f353cd-ebd7-462a-bd57-1498dc8b88a6), [Get\-Item](assetId:///4ed2b1e1-fde4-4425-90a0-87774477fefa), [Get\-ChildItem](assetId:///75cf79bb-4db6-4a67-8c36-3d20754e2190), [Invoke\-Item](assetId:///61bc0652-39d8-44fe-9ff4-476ae75c38c8), [Move\-Item](assetId:///de1b4217-de99-45cd-a12c-35e87b0c8466), [New\-Item](assetId:///67038d02-6598-49c6-b5bd-77b59d445abe), and [Remove\-Item](assetId:///0fe3ff11-a1f7-43b9-8c85-f92d52641395) cmdlets.  
  
 In Windows PowerShell 2.0, the Certificate provider supports the [Get\-Location](assetId:///b4c8d674-ba23-4bdf-8322-1f08acdc0ca9), [Set\-Location](assetId:///d7f353cd-ebd7-462a-bd57-1498dc8b88a6), [Get\-Item](assetId:///4ed2b1e1-fde4-4425-90a0-87774477fefa), [Get\-ChildItem](assetId:///75cf79bb-4db6-4a67-8c36-3d20754e2190), and [Invoke\-Item](assetId:///61bc0652-39d8-44fe-9ff4-476ae75c38c8) cmdlets.  
  
 In addition, Windows PowerShell Security module \(Microsoft.PowerShell.Security\), which includes the Certificate provider, also includes cmdlets to get and set Authenticode signatures and to get certificates. For a list of cmdlets in the Security module, type "[Get\-Command](assetId:///59c6d302-6e8c-48b7-a6f6-f0172df936ad) \-module \*security".  
...
### DeleteKey \<System.Management.Automation.SwitchParameter\>  
 ...
 To delete a private key that is associated with a user certificate in the Cert:\\CurrentUser store on a remote computer, you must use delegated credentials. When using the [Invoke\-Command](assetId:///906b4b41-7da8-4330-9363-e7164e5e6970) cmdlet to run a [Remove\-Item](assetId:///0fe3ff11-a1f7-43b9-8c85-f92d52641395) command remotely, after considering the security risks, use the CredSSP parameter to enable delegation.  
...
## See Also  
 ...
 [Get\-AuthenticodeSignature&#91;PSITPro5\_Security&#93;](assetId:///36e5e640-2125-476e-98d9-495977315f14)   
 [Set\-AuthenticodeSignature&#91;PSITPro5\_Security&#93;](assetId:///f3c13299-4463-48af-83ea-86de4a239509)   
