...
LONG DESCRIPTION  
 ...
 WHAT'S NEW IN MODULES: Module Auto-Loading  
    ...
    modules automatically the first time that you use any command in   
    ...
    to be discovery, not use, and do not import any modules.  
  
    Only module that are stored in the location specified by the PSModulePath  
    environment variable are automatically imported. Modules in other locations  
    must be imported by using the Import-Module cmdlet.  
    ...
    use the Import-Module cmdlet to import the Microsoft.WSMan.Management  
    module that includes the WSMan: drive.  
  
    You can still use the Import-Module command to import a module and  
 ...
 HOW TO INSTALL A MODULE  
    ...
    to install it on your computer before you can use it into Windows  
    PowerShell.  
