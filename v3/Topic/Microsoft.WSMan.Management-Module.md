...
This section contains the help topics for the **Microsoft.WSMan.Management** module, which contains the [WSMan Provider](../Topic/WSMan-Provider.md) and cmdlets that manage Web Services for Management \(WS\-Management\) and Windows Remote Management \(WinRM\). The **Microsoft.WSMan.Management** module is installed with [!INCLUDE[mshshort]()].  
