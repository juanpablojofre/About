...
### HOW TO CHOOSE A PROFILE  
 ...
 If you are an administrator who is customizing [!INCLUDE[wps_2]()] for many users, follow these guidelines:  
...
```  
 ...
 \-\- Add an Add\-PsSnapin command to add any [!INCLUDE[wps_2]()] snap\-ins that you use.  
