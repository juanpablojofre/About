...
```  
 ...
 Instead of removing the item, [!INCLUDE[wps_2]()] lists the operations it would perform and the items that would be affected. This command produces the following output:  
