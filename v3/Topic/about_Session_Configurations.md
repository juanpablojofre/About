...
LONG DESCRIPTION  
  ...
  Changing the Security Descriptor of a Session Configuration  
      ...
      In Windows Server 2012 and newer releases of the Windows Server   
      operating system, the built-in session configurations are enabled  
      for remote users by default. In other supported versions of Windows,  
      you must change the security descriptors of the session configurations  
