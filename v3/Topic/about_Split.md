  ...
  PARAMETERS  
   ...
   <Delimiter>  
    ...
    <Max-substrings>  
        ...
        the Max-substrings limit is applied to each string separately. In the following  
        example, two distinct strings are passed into –split; each source string results  
        in three output strings.  
