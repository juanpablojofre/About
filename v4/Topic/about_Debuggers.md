...
### DEBUGGING WORKFLOWS  
 The [!INCLUDE[wps_2]()] 4.0 debugger can be used to debug [!INCLUDE[wps_2]()] workflows, either in the [!INCLUDE[wps_2]()] console, or in [!INCLUDE[wps_2]()]ISE. There are some limitations with using the [!INCLUDE[wps_2]()] debugger to debug workflows.  
