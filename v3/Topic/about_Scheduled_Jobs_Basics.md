...
LONG DESCRIPTION  
  ...
  HOW TO CREATE A SCHEDULED JOB   
    ...
    script that the job runs. You can create a job trigger and  
    set job options when you create the job or at a later time.  
  ...
  HOW TO CREATE A JOB TRIGGER  
    ...
    any time by using the Start-Job cmdlets.  
