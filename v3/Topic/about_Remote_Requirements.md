...
LONG DESCRIPTION  
 ...
 SYSTEM REQUIREMENTS  
    ...
    Windows Remote Management (WinRM) 3.0 and Microsoft .NET Framework 4.0 are included  
    in Windows 8 and Windows Server 2012. WinRM 3.0 is included in Windows Management  
    Framework 3.0 for downlevel systems. If the computer does not have the required  
...
.  
 ...
 HOW TO CONFIGURE YOUR COMPUTER FOR REMOTING     
    ...
    Windows Server 2012 is enabled for Windows PowerShell remoting by default.  
