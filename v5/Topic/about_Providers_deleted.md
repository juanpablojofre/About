...
```  
 ...
 You can also create your own [!INCLUDE[wps_2](../Token/wps_2_md.md)] providers, and you can install providers that others develop. To list the providers that are available in your session, type:  
